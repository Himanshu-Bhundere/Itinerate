...
const s = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#f8fafc', alignItems: 'center', paddingHorizontal: 20 },

  logoRow: { alignItems: 'center', marginBottom: 16 },
  logoText: { fontSize: 24, fontWeight: '800', color: '#2563eb', fontStyle: 'italic' },

  celebrationContainer: { width: width - 40, height: 240, marginBottom: 8, position: 'relative' },
  celebrationImage: { width: '100%', height: '100%' },
  celebrationOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 24 },
  ...
  title: { fontSize: 24, fontWeight: '800', color: '#0f172a', textAlign: 'center', marginTop: 32, marginBottom: 8 },
  subtitle: { fontSize: 14, color: '#64748b', textAlign: 'center', lineHeight: 20, marginBottom: 24 },

  planCard: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 20, padding: 12, width: '100%', borderWidth: 1, borderColor: '#e2e8f0', marginBottom: 32 },
  planCardImage: { width: 100, height: 100, borderRadius: 16 },
  ...
  actions: { width: '100%' },
  viewPlanBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#14b8a6', height: 56, borderRadius: 16, marginBottom: 12, position: 'relative' },
  viewPlanText: { color: '#fff', fontSize: 16, fontWeight: '700' },
  shareBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', height: 56, borderRadius: 16, borderWidth: 1.5, borderColor: '#10b981', marginBottom: 12, position: 'relative' },
  shareBtnText: { color: '#10b981', fontSize: 16, fontWeight: '700' },
  createAnotherBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', height: 56, borderRadius: 16, borderWidth: 1.5, borderColor: '#f97316', position: 'relative' },
